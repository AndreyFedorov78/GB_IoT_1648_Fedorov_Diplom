...
void mhz19Calib0(); // калибровка датчика на улице (400ppm);
int mhz19Check(); // проверка работоспособности датчика, должа вернуть HALL_OK
int mhz19GetPPM(); // получение концентрации СО2
void mhz19CalibOff(); // Отчлючение автокалибровки (включена по умолчанию(
void mhz19Range(uint32_t range); // установка пределов измерения, возможные аргументы 2000, 5000 или 10000
